...
=> nil
irb#1(main):032:0> def age_in_seconds(years)
irb#1(main):033:1> years * weeks_in_years(days_in_weeks(hours_in_days(minutes_in_hours(seconds_in_minutes(1)))))
irb#1(main):034:1> end
=> nil
irb#1(main):038:0> print "If you are 18 years old, you are " + age_in_seconds(18).to_s + " seconds old."
If you are 18 years old, you are 566092800.0 seconds old.=> nil
